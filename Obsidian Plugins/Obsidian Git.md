...
<<<<<<< HEAD
아니 아이패드는 되네..? 근데 풀은 왜 또 안댐.. 다시 해보면 되나..? ssh로 하면 되나 ssh로 바꿔서 레포 받았더니 갑자기 됐어 아이폰에선 ssh로 깃 제어하는 게 나은 건가? 아 ssh로 해야 잘 되네
=======
아니 아이패드는 되네..? 근데 풀은 왜 또 안댐.. 다시 해보면 되나..? ssh로 하면 되나 ssh로 바꿔서 레포 받았더니 갑자기 됐어 아이폰에선 ssh로 깃 제어하는 게 나은 건가? 아 ssh로 해야 잘 되네 이제 되나..?
>>>>>>> main
